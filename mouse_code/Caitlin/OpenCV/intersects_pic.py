...
def intersect(vid):
    ...
    ret = np.load("./Calibration/camera1_params/ret.npy")
    mtx = np.load("./Calibration/camera1_params/mtx.npy")
    dist = np.load("./Calibration/camera1_params/dist.npy")
    rvecs = np.load("./Calibration/camera1_params/rvecs.npy")
    tvecs = np.load("./Calibration/camera1_params/tvecs.npy")
    newmtx = np.load("./Calibration/camera1_params/newmtx.npy")
